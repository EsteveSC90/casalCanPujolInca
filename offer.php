				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
                                <?php echo traducir('oferta'); ?>
							</h1>	
							<p class="text-white link-nav"><a href="index.php"><?php echo traducir('home'); ?> </a>  <span class="lnr lnr-arrow-right"></span>  <a href="offer.php"> <?php echo traducir('oferta'); ?></a></p>
						</div>											
					</div>
				</div>
			</section>
