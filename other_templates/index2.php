				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-8">
							<h6 class="text-white"><?php echo traducir('opening'); ?></h6>
							<h1 class="text-white">
                                <?php echo traducir('bienvenida'); ?>
							</h1>
							<p class="pt-20 pb-20 text-white">
                                <?php echo traducir('textobienvenida'); ?>
							</p>
							<a href="#about" class="primary-btn text-uppercase"><?php echo traducir('comenzar'); ?></a>
						</div>											
					</div>
				</div>					
			</section>
							...
							<div class="single-service">
							  ...
							  <div class="overlay">
							    <div class="text">
							    	...
							    	<a href="#" class="text-uppercase primary-btn">Contact us</a>
							    </div>
							  </div>
							</div>							
						</div>
